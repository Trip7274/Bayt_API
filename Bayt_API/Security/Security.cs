...
public static class SecurityMethods
{
	...
	extension (WebApplicationBuilder builder)
	{
		public void AddAuthenticationSchemes()
		{
				...
				options.Events = new CertificateAuthenticationEvents
				{
					...
					OnAuthenticationFailed = context =>
					{
						switch (context.Exception.Message)
						{
							...
							{
								context.Fail("The presented certificate was not found in Bayt's trusted database.");
								break;
							}
							default:
							{
			...
			{
				options.Cookie.Name = "BaytCookie";
	...
	public static bool ChallengePermission(HttpContext context, Permissions.BaytPermission challengingPermission)
	{
